...
public class ProductGroupServiceImpl implements ProductGroupService{
    ...
    @Autowired
    public ProductGroupServiceImpl(ProductGroupRepository productGroupRepository, ProductGroupMapperDto productGroupMapperDto, ProductTypeRepository productTypeRepository) {
